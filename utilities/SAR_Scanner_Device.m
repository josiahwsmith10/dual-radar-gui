    ...
    methods
        ...
        function str = createScanNotesStrRectilinear(obj)
            ...
            str = [
                ...
                ""
                sprintf("Initial-X (mm)\t%f",obj.amc.curr_hor_mm)
                sprintf("Initial-Y (mm)\t%f",obj.amc.curr_ver_mm)
                ""
                "User Notes:"
        ...
        function CreateScanTestScripts(obj)
            % Creates the scripts for testing the images
        ...
        function CreateRadar1TestScript(obj)
            % Create the test script for radar 1

            fid = fopen(cd + "\data\" + date + "\" + obj.fileName + "\" + obj.fileName + "_radar1.m","wt");
            
            if fid == -1
                obj.textArea.Value = "Error creating radar 1 test script!";
                fclose(fid);
                return
            end
            
            % Print the load scan script string
            fprintf(fid,'%s\n',obj.createRadar1TestScriptStr());
            
            fclose(fid);
        end

        function CreateRadar2TestScript(obj)
            % Create the test script for radar 2

            fid = fopen(cd + "\data\" + date + "\" + obj.fileName + "\" + obj.fileName + "_radar2.m","wt");
            
            if fid == -1
                obj.textArea.Value = "Error creating radar 2 test script!";
                fclose(fid);
                return
            end
            
            % Print the load scan script string
            fprintf(fid,'%s\n',obj.createRadar2TestScriptStr());
            
            fclose(fid);
        end

        function CreateDualRadarSRTestScript(obj)
            % Create the test script for dual-radar

            fid = fopen(cd + "\data\" + date + "\" + obj.fileName + "\" + obj.fileName + "_dual_radar_SR.m","wt");
            
            if fid == -1
                obj.textArea.Value = "Error creating dual radar test script!";
                fclose(fid);
                return
            end
            
            % Print the load scan script string
            fprintf(fid,'%s\n',obj.createDualRadarSRTestScriptStr());
            
            fclose(fid);
        end

        function CreateDualRadarTestScript(obj)
            % Create the test script for dual-radar

            fid = fopen(cd + "\data\" + date + "\" + obj.fileName + "\" + obj.fileName + "_dual_radar.m","wt");
            ...
            % Print the load scan script string
            fprintf(fid,'%s\n',obj.createDualRadarTestScriptStr());
            
            fclose(fid);
        end

        function str = createRadar1TestScriptStr(obj)
        ...
        function str = createRadar2TestScriptStr(obj)
        ...
        function str = createDualRadarTestScriptStr(obj)
        ...
        function str = createDualRadarSRTestScriptStr(obj)
